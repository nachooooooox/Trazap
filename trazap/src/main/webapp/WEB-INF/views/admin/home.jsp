		...
		<div class="row justify-content-md-center text-center">
			<div class="col">
				<div class="card bg-light mt-5">
					<div class="card-body">
						<p>Sistema que permite gestionar las categorías de los productos, en donde se puede ver, crear, eliminar y modificar </p>
						<a class="btn btn-sm btn-primary" href="/trazap/admin/gestionCategorias">IR</a>
					</div>
				</div>
			</div>
			<div class="col">
